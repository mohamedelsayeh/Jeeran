...
public class LiquidFloatingActionButton : UIView {
    ...
    @IBInspectable public var color: UIColor = UIColor(red: 221 / 255.0, green: 97 / 255.0, blue: 79 / 255.0, alpha: 1.0) {
        didSet {
    ...
    public override func touchesEnded(_ touches: Set<UITouch>, withEvent event: UIEvent?) {
        self.touching = false
        setNeedsDisplay()
        didTapped()
    }
